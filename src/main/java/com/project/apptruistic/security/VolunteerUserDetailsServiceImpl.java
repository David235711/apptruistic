...
@Service
public class VolunteerUserDetailsServiceImpl implements UserDetailsService {
    @Autowired
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        Volunteer volunteer = volunteerRepository.findOneByEmail(email)
                .orElseThrow(() -> new UsernameNotFoundException("Volunteer not found with email: " + email));
