...
public class ApptruisticRunner {
    ...
    ApplicationRunner prepareStuff(OpportunityRepository opportunityRepository, VolunteerRepository volunteerRepository) {
        return args -> {
//            Optional<Opportunity> optionalOpportunity1 = opportunityRepository.findOneByHashcode(-173726471);
//            Optional<Opportunity> optionalOpportunity2 = opportunityRepository.findOneByHashcode(1148693535);
